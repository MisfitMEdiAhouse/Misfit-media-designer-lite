...
const FALLBACK = {
  ...
  agents: [
    ...
    { slug: 'ghosbc-safety-gate', name: 'GHOSBC Safety Gate', category: 'security_runtime', status: 'private', security_class: 'private', summary: 'Private upstream governance kernel used by Misfit-controlled systems. Public agents consume only the bounded Misfit governed-action contract.', capabilities: [] },
...
const healthLabels = {
  ...
  safety_gate_mcp: 'Governance boundary',
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-7xl px-5 pb-24 pt-32">
        <section id="private-core" className="relative scroll-mt-24 overflow-hidden rounded-[2rem] border border-cyan-400/20 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,.12),transparent_35%),linear-gradient(135deg,rgba(15,23,42,.9),rgba(0,0,0,1))] p-7 md:p-10">
        ...
        <section id="governance" className="mt-10 grid scroll-mt-24 gap-4 lg:grid-cols-4">
