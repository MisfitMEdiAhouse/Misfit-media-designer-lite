    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <main>
        <section className="mx-auto max-w-7xl px-5 pb-16 pt-20 sm:pt-28">
          <div className="font-mono text-xs uppercase tracking-[0.28em] text-cyan-300">MISFIT QUOTELINK · $49 ONE TIME</div>
          <div className="mt-6 grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            <div>
              <h1 className="font-display text-5xl font-extrabold uppercase leading-[.92] tracking-[-.055em] sm:text-7xl lg:text-8xl">A business link built to get the quote.</h1>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">Misfit QuoteLink turns a few business details into a sharp, hosted one-page lead site customers can open from a text, social bio, QR code, flyer, business card, or vehicle.</p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-7 sm:p-9">
              <div className="flex items-center justify-between border-b border-white/10 pb-5">
                <div>
                  <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-slate-500">MISFIT QUOTELINK</div>
          ...
          <div className="mx-auto max-w-7xl px-5">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              {[
                ...
                [Zap, '02', 'Stripe confirms payment', 'Checkout is hosted by Stripe. The generator does not publish the page until payment is confirmed.'],
                [QrCode, '03', 'Your URL + QR appear', 'The customer gets the hosted QuoteLink page and a QR code on the success screen.'],
        ...
        <section className="border-t border-white/5 py-16">
          <div className="mx-auto max-w-5xl px-5 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-slate-400">QuoteLink is deliberately smaller than a custom website. It gives a local operator one fast, clean link whose job is to turn attention into a phone call, text, or quote request.</p>
            <div className="mt-8 flex justify-center gap-3 flex-wrap">
              <a href={BUY_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3.5 font-mono text-xs font-bold uppercase tracking-[0.16em] text-black">Create a QuoteLink <ArrowRight size={15}/></a>
