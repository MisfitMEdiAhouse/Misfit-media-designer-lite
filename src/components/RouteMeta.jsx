...
const publicMeta = {
  ...
  '/signal': ['/signal', 'Misfit Trader is free-first market intelligence and paper trading: live public market signals, explainable regimes, candle learning, autonomous paper strategies, reconsideration evidence, and hard-gated real-money execution.'],
  '/gaming': ['/gaming', 'Misfit Gaming OS reuses one growth architecture across game communities. GTA/FiveM is live first, with Minecraft, Rust, Roblox, Fortnite/UEFN and later server ecosystems staged behind measurable proof.'],
  '/gta': ['/gta', 'Misfit GTA Growth OS is the live first lane of Misfit Gaming OS: free growth audit, free founding pilot, creator/community distribution, approved server discovery, and optional managed growth.'],
...
const publicTitles = {
  ...
  '/signal': 'Misfit Trader | Free-First Market Intelligence + Paper Trading',
  '/gaming': 'Misfit Gaming OS | GTA, Minecraft, Rust, Roblox + UEFN Growth',
  '/gta': 'Misfit GTA Growth OS | Free Audit + Founding Pilot',
