...
const publicMeta = {
  ...
  '/worldforge': ['/worldforge', 'WorldForge Emotional Radar is Misfit Mediahouse market intelligence: emotion-first public market signals, explainable regimes, and a live virtual-money paper-trading sandbox with real-money execution disabled.'],
...
const publicTitles = {
  ...
  '/worldforge': 'WorldForge Emotional Radar | Misfit Mediahouse',
